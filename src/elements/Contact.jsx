...
const Contact = () => {
  ...
  const getContact = () => {
    ...
    fetch(`${baseURL}contact/63be7ca47ec18f6690c235a2`, {
      method: "GET",
      headers,
    })
  ...
  return (
    <React.Fragment>
      ...
      <div
        className="rn-page-title-area pt--120 pb--190 bg_image bg_image--30"
            ...
            <div className="col-lg-4 col-md-6 col-sm-6 col-12">
              <div className="rn-address">
                ...
                <div className="inner">
                  ...
                  <p>
                    <a href="tel:+234 803 666 777">+234 {phone1}</a>
                  </p>
                  {phone2 ? (
                    <p>
                      <a href="tel:+234 803 222 333">+234 {phone2}</a>
                    </p>
                  ) : null}
                </div>
              </div>
