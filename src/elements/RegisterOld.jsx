                  ...
                  <div className="row row--35">
                    ...
                    <div className="rn-form-group mb-3 col-md-6">
                      <Multiselect
                        options={[
                          ...
                          { id: 2, name: "Livestock", option: "Livestock" },
                          { id: 3, name: "Poultry", option: "Poultry" },
                          { id: 4, name: "Aquaculture", option: "Aquaculture" },
                          {
                            id: 5,
                            name: "Horticulture",
                            option: "Horticulture",
                    ...
                    <div className="rn-form-group mb-3 col-md-6">
                      ...
                      >
                        <Form.Control
                          type="number"
                          aria-label="Crop Income (to the nearest Naira)"
                          placeholder="Crop Income (to the nearest Naira)"
                          onChange={(e) => setCropsIncome(e.target.value)}
                        />
                      </FloatingLabel>
                    </div>
                    ...
                    <div className="rn-form-group col-md-6">
                      ...
                      >
                        <Form.Control
                          type="number"
                          name="totalIncomeRevenue"
                          aria-label="Total Income Revenue (to the nearest Naira)"
                          onChange={(e) =>
                            setTotalIncomeRevenue(e.target.value)
                          }
                          placeholder="Total Income Revenue (to the nearest Naira)"
                        />
                      </FloatingLabel>
                    </div>
                    ...
                    <div className="rn-form-group mb-3 col-md-6">
                      <FloatingLabel
                        controlId="floatingSelect"
                        label="Primary Purpose of Farming"
                      >
                        <Form.Select
                          aria-label="Primary Purpose of Farming"
                          name="primaryPurposeOfFarming"
                          size="lg"
                          onChange={(e) =>
                            setPrimaryPurposeOfFarming(e.target.value)
                          }
                          required
                        >
                          <option></option>
                    ...
                    <div className="rn-form-group mb-3 col-md-6">
                      <FloatingLabel
                        controlId="floatingSelect"
                        label="Farm Land Ownership"
                      >
                        <Form.Select
                          aria-label="Farm Land Ownership"
                          name="accessToOffTakers"
                          size="lg"
                          onChange={(e) => setAccessToOffTakers(e.target.value)}
                          required
                        >
                          <option></option>
                    ...
                    <div className="rn-form-group mb-3 col-md-6">
                      <FloatingLabel
                        controlId="floatingSelect"
                        label="Do you have access to Input Providers"
                      >
                        <Form.Select
                          aria-label="Do you have access to Input Providers"
                          name="accessToInputProviders"
                          size="lg"
                          onChange={(e) =>
                            setAccessToInputProviders(e.target.value)
                          }
                          required
                        >
                          <option></option>
                    ...
                    <div className="rn-form-group mb-3 col-md-6">
                      <FloatingLabel
                        controlId="floatingSelect"
                        label="Do you have Access to Advisory Services"
                      >
                        <Form.Select
                          aria-label="Do you have Access to Advisory Services"
                          name="accessToAdvisoryServices"
                          size="lg"
                          onChange={(e) =>
                            setAccessToAdvisoryServices(e.target.value)
                          }
                          required
                        >
                          <option></option>
                    ...
                    <div className="rn-form-group mb-3 col-md-6">
                      <FloatingLabel
                        controlId="floatingSelect"
                        label="Do you have Access to Government Land for Farming"
                      >
                        <Form.Select
                          aria-label="Do you have Access to Government Land for Farming"
                          name="accessToGovernmentLandForFarming"
                          size="lg"
                          onChange={(e) =>
                            setAccessToGovernmentLandForFarming(e.target.value)
                          }
                          required
                        >
                          <option></option>
                    ...
                    <div className="rn-form-group mb-3 col-md-6">
                      <FloatingLabel
                        controlId="floatingSelect"
                        label="Do you have Access to Financial Service Providers"
                      >
                        <Form.Select
                          aria-label="Do you have Access to Financial Service Providers"
                          name="accessToFinancialServiceProviders"
                          size="lg"
                          onChange={(e) =>
                            setAccessToFinancialServiceProviders(e.target.value)
                          }
                          required
                        >
                          <option></option>
                    ...
                    <div className="rn-form-group mb-3 col-md-6">
                      <FloatingLabel
                        controlId="floatingSelect"
                        label="Do you have Access to Extension Suport"
                      >
                        <Form.Select
                          aria-label="Do you have Access to Extension Suport"
                          name="accessToExtensionSuport"
                          size="lg"
                          onChange={(e) =>
                            setAccessToExtensionSuport(e.target.value)
                          }
                          required
                        >
                          <option></option>
                    ...
                    <div className="rn-form-group mb-3 col-md-6">
                      <FloatingLabel
                        controlId="floatingSelect"
                        label="Incentive From Govt"
                      >
                        <Form.Select
                          aria-label="Incentive From Govt"
                          name="incentiveFromGovt"
                          size="lg"
                          onChange={(e) => setIncentiveFromGovt(e.target.value)}
                          required
                        >
                          <option></option>
                          <option value="yes">Yes</option>
                    ...
                    <div className="rn-form-group mb-3 col-md-6">
                      <FloatingLabel
                        controlId="floatingSelect"
                        label="Do you have Access to Business Service Providers"
                      >
                        <Form.Select
                          aria-label="Do you have Access to Business Service Providers"
                          name="accessToBusinessServiceProviders"
                          onChange={(e) =>
                            setAccessToBusinessServiceProviders(e.target.value)
                          }
                          size="lg"
                          required
                        >
                    ...
                    <div className="rn-form-group mb-3 col-md-6">
                      <FloatingLabel
                        controlId="floatingSelect"
                        label="Do you have Access to Mechanization Service Providers"
                      >
                        <Form.Select
                          aria-label="Do you have Access to Mechanization Service Providers"
                    ...
                    <div className="rn-form-group mb-3 col-md-6">
                      <FloatingLabel
                        controlId="floatingSelect"
                        label="Crop Management Techniques"
                      >
                        <Form.Select
                          aria-label="Crop Management Techniques"
                          name="cropManagementTechniques"
                          size="lg"
                          onChange={(e) =>
                            setCropManagementTechniques(e.target.value)
                          }
                          required
                        >
                          <option></option>
                    ...
                    <div className="rn-form-group mb-3 col-md-6">
                      <FloatingLabel
                        controlId="floatingSelect"
                        label="Soil Management Techniques"
                      >
                        <Form.Select
                          aria-label="Soil Management Techniques"
                          name="soilManagementTechniques"
                          size="lg"
                          onChange={(e) =>
                            setSoilManagementTechniques(e.target.value)
                          }
                          required
                        >
                          <option></option>
